...
window.Strategy = (function () {
  ...
  const STRATEGY_MODS = {
    ...
    'five_out|2_3_zone':             [5,  0,   0,   0.5,-1,   2,  3, 0,0,0,0,false],
    ...
    'pick_and_roll|2_3_zone':        [-10,0,   0,   0.5, 2,   2,  3, 0,0,0,0,false],
    ...
    'motion|2_3_zone':               [5,  0,   0,   0,  -2,   2,  3, 0,0,0,0,false],
    ...
    'low_post|2_3_zone':             [0,  0,   0,   0.5,-2,   2,  3, 0,0,0,0,false],
    'low_post|1_3_1_zone':           [-10,0.5, 0,   0,   0,  -1,  5, 0,0,0,0,false],
    'low_post|matchup_zone':         [-10,0,   0.5, 0,   2,   2,  3, 0,0,0,0,false],
