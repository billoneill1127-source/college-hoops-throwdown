...
window.CpuSim = (() => {
  ...
  function simulateGame(homeTeam, awayTeam, options) {
    ...
    return {
      ...
      gameId,
      fastBreaks: {
        home: { ...(_G.homeFB || { count: 0, pts: 0 }) },
        away: { ...(_G.awayFB || { count: 0, pts: 0 }) },
      },
      summary: {
        home: {
          ...
          fastBreaks:    (_G.homeFB || {}).count || 0,
          fastBreakPts:  (_G.homeFB || {}).pts   || 0,
        },
        away: {
          ...
          fastBreaks:    (_G.awayFB || {}).count || 0,
          fastBreakPts:  (_G.awayFB || {}).pts   || 0,
        },
      },
    };
  }
